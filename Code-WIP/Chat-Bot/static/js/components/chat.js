...
function getBotResponse(text) {
    botResponse = `<img class="botAvatar" src="./static/img/botAvatar.jpeg"/><span class="botMsg">${text}</span><div class="clearfix"></div>`;
    return botResponse;
}
...
function setBotResponse(response) {
    ...
    setTimeout(() => {
        ...
        if (response.length < 1) {
            ...
            const BotResponse = `<img class="botAvatar" src="./static/img/botAvatar.jpeg"/><p class="botMsg">${fallbackMsg}</p><div class="clearfix"></div>`;
                ...
                if (Object.hasOwnProperty.call(response[i], "text")) {
                    if (response[i].text != null) {
                        ...
                        if (html.includes("<ul") || html.includes("<ol") || html.includes("<li") || html.includes('<h3')) {
                            ...
                            if (!botResponse) {
                                botResponse = `<img class="botAvatar" src="./static/img/botAvatar.jpeg"/><p class="botMsg">${response[i].text}</p><div class="clearfix"></div>`;
                            }
                        }
